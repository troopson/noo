...
public class PageList implements Serializable{
		...
		private List resultList;
		   ...
		   */
		  public PageList(String sql,Object[] args,int currentPage,int numPerPage,JdbcTemplate jTemplate){
		    if(jTemplate == null){
		  ...
		  //提供一个可以执行命名参数的方法
		  public PageList(String sql,Map<String,?> args,int currentPage,int numPerPage,NamedParameterJdbcTemplate jTemplate){
			    if(jTemplate == null){
			      throw new IllegalArgumentException("PageInation.jTemplate is null,please initial it first. ");
			    }else if(sql == null || sql.equals("")){
			      throw new IllegalArgumentException("PageInation.sql is null,please initial it first. ");
