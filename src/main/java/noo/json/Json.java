...
public class Json {
   ...
   * @throws EncodeException if a property cannot be encoded.
   */
  public static byte[] encodeToBuffer(Object obj) throws EncodeException {
    try {
   ...
   * @throws DecodeException when there is a parsing or invalid mapping.
   */
  public static <T> T decodeValue(byte[] buf, TypeReference<T> type) throws DecodeException {
    try {
      return mapper.readValue(buf, type);
    } catch (Exception e) {
      throw new DecodeException("Failed to decode:" + e.getMessage(), e);
    }
  }
   ...
   * @throws DecodeException when there is a parsing or invalid mapping.
   */
  public static <T> T decodeValue(byte[] buf, Class<T> clazz) throws DecodeException {
    try {
